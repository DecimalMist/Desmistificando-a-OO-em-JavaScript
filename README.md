...
DESAFIO 1 
Um objeto literal é uma lista de valores ou atribuçoes dadas a um objeto.

O node.js permite a alteraçao de um objeto devido que eu nao estou trocando a constante, mas apenas alterando os dados referentes as propriedades do objeto, e nao reatribuindo o proprio objeto
